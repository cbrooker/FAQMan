...
var OxOf357=["ondblclick","navtd","shiftKey","style"]; Window_GetElement(window,OxOf357[0x1],true)[OxOf357[0x0]]=function (){if(event[OxOf357[0x2]]){ alert(element[OxOf357[0x3]].cssText) ;} ;}  ;
</script>
